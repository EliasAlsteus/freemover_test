...
City images sourced via Wikivoyage/Wikipedia page images (Wikimedia Commons).

- **delft.jpg** (Delft, via en.wikivoyage.org): `File:DelftCanal.jpg` — Niels Elgaard Larsen - User: (WT-shared) Elgaard at  wts wikivoyage, CC BY-SA 4.0
- **amsterdam.jpg** (Amsterdam, via en.wikivoyage.org): `File:KeizersgrachtReguliersgrachtAmsterdam.jpg` — Massimo Catarinella, CC BY-SA 3.0
- **eindhoven.jpg** (Eindhoven, via en.wikivoyage.org): `File:EindhovenLightTower.jpg` — User: (WT-shared) Justme at  wts wikivoyage, CC BY-SA 3.0
- **utrecht.jpg** (Utrecht, via en.wikivoyage.org): `File:Utrecht_Oudegracht_Domtoren.jpg` — Sara2605, Public domain
- **helsinki.jpg** (Helsinki, via en.wikivoyage.org): `File:Catedral_Luterana_de_Helsinki,_Finlandia,_2012-08-14,_DD_14.JPG` — Diego Delso, CC BY-SA 3.0
- **joensuu-kuopio.jpg** (Kuopio, via en.wikivoyage.org): `File:Kuopio_market_place_2011.jpg` — Lentävä Kalakukko, CC0
- **hsinchu.jpg** (Hsinchu, via en.wikivoyage.org): `File:East_gate,_Hsin-chu.jpg` — User: (WT-shared) Trcheng at  wts wikivoyage (Original text: Picture by: T.R Cheng), CC BY-SA 1.0
- **taipei.jpg** (Taipei, via en.wikivoyage.org): `File:Ximending_rainbow_crossing_201910.jpg` — Volksabstimmung, CC BY-SA 2.0
- **san-diego.jpg** (San Diego, via en.wikivoyage.org): `File:San_diego_region.png` — PerryPlanet, CC BY-SA 4.0
- **seuol.jpg** (Seoul, via en.wikivoyage.org): `File:Korea-Seoul-Cheonggyecheon-2008-01.jpg` — stari4ek, CC BY-SA 2.0
- **stellenbosch.jpg** (Stellenbosch, via en.wikivoyage.org): `File:StellenboschWC-Aerial.jpg` — Andres de Wet, CC BY-SA 3.0
- **auckland.jpg** (Auckland, via en.wikivoyage.org): `File:Auckland_WV_districts_map_EN.png` — Shaundd, CC BY-SA 4.0
- **groningen.jpg** (Groningen, via en.wikivoyage.org): `File:Groningen_-_Hoge_der_A_-_vanaf_de_A-brug_-_Bert_Kaufmann.jpg` - Bert Kaufmann, CC BY-SA 3.0
- **copenhagen.jpg** (Copenhagen, via en.wikivoyage.org): `File:CPH_Rundetaarn_-_view_towards_the_Copenhagen_Cathedral.jpg` - Flickr user:  Casper Moller London, United Kingdom https://www.flickr.com/people/caspermoller/, CC BY 2.0
- **vienna.jpg** (Vienna, via en.wikivoyage.org): `File:0101-0102_-_Wien_-_Naitonalbibliothek.jpg` - Andrew Bossi, CC BY-SA 2.5
- **munich.jpg** (Munich, via en.wikivoyage.org): `File:Munich_-_Details_in_the_front_of_the_Neues_Rathaus_-_7432.jpg` - Jorge Royan, CC BY-SA 3.0
- **dublin.jpg** (Dublin, via en.wikivoyage.org): `File:HalfPennyBridge.jpg` - unknown, Public domain
- **singapore.jpg** (Singapore, via en.wikivoyage.org): `File:Skylines_of_the_Central_Business_District,_Singapore_at_dusk.jpg` - Basile Morin, CC BY-SA 4.0
- **hong-kong.jpg** (Hong Kong, via en.wikivoyage.org): `File:City_Boundary_1903_-_Old_Peak_Road.jpg` - Minghong, CC BY-SA 4.0
- **tokyo.jpg** (Tokyo, via en.wikivoyage.org): `File:TokyoTocho.jpg` - unknown, Public domain
